...
unsigned char buff2_1a[ROW][COL];
unsigned char buff2_1b[ROW][COL];
unsigned char buff2_1c[ROW][COL];
unsigned char buff2_1d[ROW][COL];
unsigned char buff2_2a[ROW][COL];
unsigned char buff2_2b[ROW][COL];
unsigned char buff2_2c[ROW][COL];
unsigned char buff2_2d[ROW][COL];
unsigned char buff2_3a[ROW][COL];
unsigned char buff2_3b[ROW][COL];
unsigned char buff2_3c[ROW][COL];
unsigned char buff2_3d[ROW][COL];
...
{ 
	// Read & Write할 파일이름 지정  
	char readfilename_grayscale[30] = "after_RGB_to_Gray.bmp";				
	...
	*fpwrite_1a, *fpwrite_1b, *fpwrite_1c, *fpwrite_1d, *fpwrite_2a, *fpwrite_2b, *fpwrite_2c, *fpwrite_2d, *fpwrite_3a, *fpwrite_3b, *fpwrite_3c, *fpwrite_3d;	
	...
	binarization(buff_R2G_3a,buff_binar_3a,80);
	...
	for (int i = 0 ; i < ROW-1 ; i++)
		for (int j = 0 ; j < COL-1 ; j++) {
			buff2_1a[i][j] = buff_binar_1a[i*COL+j];
			buff2_1b[i][j] = buff_binar_1b[i*COL+j];
			buff2_1c[i][j] = buff_binar_1c[i*COL+j];
			buff2_1d[i][j] = buff_binar_1d[i*COL+j];
			buff2_2a[i][j] = buff_binar_2a[i*COL+j];
			buff2_2b[i][j] = buff_binar_2b[i*COL+j];
			buff2_2c[i][j] = buff_binar_2c[i*COL+j];
			buff2_2d[i][j] = buff_binar_2d[i*COL+j];
			buff2_3a[i][j] = buff_binar_3a[i*COL+j];
			buff2_3b[i][j] = buff_binar_3b[i*COL+j];
			buff2_3c[i][j] = buff_binar_3c[i*COL+j];
			buff2_3d[i][j] = buff_binar_3d[i*COL+j];
			std::cout << buff2_1a[i][j];
			
		}
	
	
	char writefilename_buff2_1a[30] = "buff2_1a.txt";		
	char writefilename_buff2_1b[30] = "buff2_1b.txt";
	char writefilename_buff2_1c[30] = "buff2_1c.txt";
	char writefilename_buff2_1d[30] = "buff2_1d.txt";
	char writefilename_buff2_2a[30] = "buff2_2a.txt";
	char writefilename_buff2_2b[30] = "buff2_2b.txt";
	char writefilename_buff2_2c[30] = "buff2_2c.txt";
	char writefilename_buff2_2d[30] = "buff2_2d.txt";
	char writefilename_buff2_3a[30] = "buff2_3a.txt";
	char writefilename_buff2_3b[30] = "buff2_3b.txt";
	char writefilename_buff2_3c[30] = "buff2_3c.txt";
	char writefilename_buff2_3d[30] = "buff2_3d.txt";
	
	FILE *fpwrite_buff2_1a, *fpwrite_buff2_1b, *fpwrite_buff2_1c, *fpwrite_buff2_1d, *fpwrite_buff2_2a, *fpwrite_buff2_2b, 
	*fpwrite_buff2_2c, *fpwrite_buff2_2d, *fpwrite_buff2_3a, *fpwrite_buff2_3b, *fpwrite_buff2_3c, *fpwrite_buff2_3d;
	
	fpwrite_buff2_1a = fopen(writefilename_buff2_1a, "wb");
	fpwrite_buff2_1b = fopen(writefilename_buff2_1b, "wb");
	fpwrite_buff2_1c = fopen(writefilename_buff2_1c, "wb");
	fpwrite_buff2_1d = fopen(writefilename_buff2_1d, "wb");
	fpwrite_buff2_2a = fopen(writefilename_buff2_2a, "wb");
	fpwrite_buff2_2b = fopen(writefilename_buff2_2b, "wb");
	fpwrite_buff2_2c = fopen(writefilename_buff2_2c, "wb");
	fpwrite_buff2_2d = fopen(writefilename_buff2_2d, "wb");
	fpwrite_buff2_3a = fopen(writefilename_buff2_3a, "wb");
	fpwrite_buff2_3b = fopen(writefilename_buff2_3b, "wb");
	fpwrite_buff2_3c = fopen(writefilename_buff2_3c, "wb");
	fpwrite_buff2_3d = fopen(writefilename_buff2_3d, "wb");
	fwrite(buff_binar_1a,1,sizeof(buff_binar_1a),fpwrite_buff2_1a);
	fwrite(buff2_1b,1, ROW * COL, fpwrite_buff2_1b);
	fwrite(buff2_1c,1, ROW * COL, fpwrite_buff2_1c);
	fwrite(buff2_1d,1, ROW * COL, fpwrite_buff2_1d);
	fwrite(buff2_2a,1, ROW * COL, fpwrite_buff2_2a);
	fwrite(buff2_2b,1, ROW * COL, fpwrite_buff2_2b);
	fwrite(buff2_2c,1, ROW * COL, fpwrite_buff2_2c);
	fwrite(buff2_2d,1, ROW * COL, fpwrite_buff2_2d);
	fwrite(buff2_3a,1, ROW * COL, fpwrite_buff2_3a);
	fwrite(buff2_3b,1, ROW * COL, fpwrite_buff2_3b);
	fwrite(buff2_3c,1, ROW * COL, fpwrite_buff2_3c);
	fwrite(buff2_3d,1, ROW * COL, fpwrite_buff2_3d);
	...
	fclose(fpwrite_3c);
	fclose(fpwrite_3d);
	fclose(fpwrite_buff2_1a);
	fclose(fpwrite_buff2_1b);
	fclose(fpwrite_buff2_1c);
	fclose(fpwrite_buff2_1d);
	fclose(fpwrite_buff2_2a);
	fclose(fpwrite_buff2_2b);
	fclose(fpwrite_buff2_2c);
	fclose(fpwrite_buff2_2d);
	fclose(fpwrite_buff2_3a);
	fclose(fpwrite_buff2_3b);
	fclose(fpwrite_buff2_3c);
	fclose(fpwrite_buff2_3d);
