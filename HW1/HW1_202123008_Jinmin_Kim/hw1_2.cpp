...
void MakeNoise(unsigned char out[])
{
...
int main()
{
	// grayscaling  (24bit -> 8bit 이미지로 바꿈 )  & Make-Noise (노이즈 추가) 
	char readfilename_my[100] = "earth_gray.bmp";				
	char readfilename_hw[100] = "shinsekai.bmp";					
	char writefilename_grayscaling[100] = "shinsekai_grayscaling.bmp";		
	...
	char readfilename_md[100] = "shinsekai_grayscaling.bmp";								
	char writefilename_md[100] = "shinsekai_median.bmp";											
	...
	// sobel (Edge 강조)
	char readfilename_sb[100] = "shinsekai_median.bmp";								
	char writefilename_sb[100] = "shinsekai_processing.bmp";											
